        ...
        <ul class="submenu-angle" aria-expanded="true">
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa big-icon fa-bell icon-wrap"></i>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Google Map" href="addteams.php"><i class="fa fa-plus-circle sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Add Teams</span></a></li>
                                <li><a title="Data Maps" href="teamlist.php"><i class="fa fa-retweet sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Team List</span></a></li>
                                <li><a title="Data Maps" href="#"><i class="fa fa-retweet sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">User List</span></a></li>
                  ...
                  <div class="row justify-content-center">
                      <div class="col-md-6 mt-5">
                          <form action="php/adduser.php" method="POST">
                              ...
                              <a href="teamlist.php" class="btn btn-success btn-block" >Go to Team List</a>
                              <div class="form-group">
                                  <label for="firstname"> Name</label>
                                  <input type="text" class="form-control" id="name" name="name" placeholder="Enter  Name" required>
                              </div>
                              <div class="form-group">
                                  <label for="lastname">Member</label>
                                  <input type="text" class="form-control" id="member" name="member" placeholder="Enter Member" required>
                              </div>
